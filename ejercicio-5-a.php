              ...
              <div class="container">
                  <div class="row">
                      <div class="col-md-12 wow bounceIn">
                          <h2 class="section-title">5- División</h2>
                          <p class="under-heading">A. Aprender a Dividir</p>
                      </div>
                  </div>
              </div>
                            ...
                            <div id="wizard" class="form_wizard wizard_horizontal">
                              ...
                              <div id="step-1">
                                  ...
                                  <section id="ejercicio-srmd">
                                    <h1 class="StepTitle">Dividir los globos</h1>
       ...
       <section id="footer">
        ...
        <script src="js/JS/custom.min.js"></script>
         ...
         <script>
            ...
            } while (num2 < 1 || num2 > num1 || num2%2 != 0);
