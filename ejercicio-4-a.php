              ...
              <div class="container">
                  <div class="row">
                      <div class="col-md-12 wow bounceIn">
                          <h2 class="section-title">4- Multiplicación</h2>
                          <p class="under-heading">A. Aprender a Multiplicar</p>
                      </div>
                  </div>
              </div>
                            ...
                            <div id="wizard" class="form_wizard wizard_horizontal">
                              ...
                              <div id="step-1">
                                  ...
                                  <section id="ejercicio-srmd">
                                    <h1 class="StepTitle">Multiplicar los globos</h1>
                                        
                                            <div id="img1"></div>
                                            <p style="font-size: 44px;">x</p>
                                            <div id="img2"></div>

                                    <input type="text" id="res" placeholder="Escriba el resultado.." class="form-control input-lg"> 
